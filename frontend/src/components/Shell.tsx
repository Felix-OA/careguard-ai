...
const navigation = [
  ...
  ['/reviews', 'Human review', '◌'], ['/policies', 'Policies', '▦'], ['/reports', 'Reports', '▤'],
...
export function Shell() {
  ...
  return <div className="app-shell">
    <aside className="sidebar" aria-label="Primary navigation">
      ...
      <div className="sidebar-foot"><span className="live-dot" aria-hidden="true" /> Local environment<small>Stage 3 · v0.3.0</small></div>
    </aside>
